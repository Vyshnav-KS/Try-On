...
export const calculateAngles2D = (
  point1: vec2,
  point2: vec2,
  axis: vec2
): number => {
...
export const applyBoneRotations = (
  ...
  setBoneAbsoluteRotation(model.bones[3], 0, 1.54, 1.54 - rtAng[0]);
  // setBoneAbsoluteRotation(model.bones[3], rtAng[1], 1.54, 1.54 - rtAng[0]);
  //
  setBoneAbsoluteRotation(model.bones[4], 0, 0, 1.54 - rbAng[0]);
